...
namespace fastJSON
{
    ...
    public static class JSON
    {
        ...
        /// <returns></returns>
        public static object Parse(string json, bool cacheStrings = false)
        {
            return new JsonParser(json, cacheStrings).Decode();
        }
#if net4
        /// <summary>
        ...
        {
            Dictionary<string, object> ht = new JsonParser(json, false).Decode() as Dictionary<string, object>;
    ...
    internal class deserializer
    {
        ...
        public object ToObject(string json, Type type)
        {
            ...
            object o = new JsonParser(json, false).Decode();
            if (o == null)
                return null;
